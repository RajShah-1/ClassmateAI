...
import { getLectureDetails, validateSummary, Lecture } from '../services/api';
        ...
        <>
          ...
          <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
             <Typography variant="h6" gutterBottom>AI-Generated Summary (Read-only)</Typography>
              <Typography variant="body1" sx={{ color: 'text.secondary', mb: 2, p:1, border: '1px solid #eee', borderRadius: 1, background: '#f9f9f9' }}>
